  ...
  <div class="layout">
    ...
    <header class="topbar">
      <div class="topbar-left">
        <button class="sidebar-toggle" @click="sidebarOpen = !sidebarOpen" title="Menu">
        ...
        <div class="logo">
          ...
          <span class="logo-text">Leadster</span>
        </div>
      </div>
      <nav class="topbar-nav">
        <a class="nav-link">Dashboard</a>
        <a class="nav-link active">Fluxos</a>
    ...
    <div class="body">
      ...
      <aside class="sidebar" :class="{ collapsed: !sidebarOpen }">
        <nav class="sidebar-nav">
          ...
          <a class="sidebar-item active">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M2 12h3m14 0h3M12 2v3m0 14v3"/></svg>
      ...
      <main class="main">
        <div class="page-header">
          <div>
            <div class="breadcrumb">Fluxos <span class="sep">/</span> Editor</div>
            <h2 class="page-title">Editor de Fluxo</h2>
          </div>
    ...
    <!-- Footer -->
    <footer class="footer">
      <span>© 2025 Leadster · Todos os direitos reservados</span>
      <span>v{{ version }}</span>
    </footer>
  </div>
</template>
...
.logo-icon { color: #58a6ff; font-size: 18px; }
...
.nav-link.active { color: #f0f6fc; background: #21262d; }
...
.sidebar-item.active { background: #1f3d5c; color: #58a6ff; }
